...
export default function Register() {
  ...
  const containerStyles = isWireframe
    ? 'min-h-screen flex items-center justify-center bg-gray-100 py-12'
    : 'min-h-screen flex items-center justify-center bg-gradient-to-br from-[#EBF5FF] to-[#F8FAFC] py-12';
    ...
    <div className={containerStyles}>
      <div className={cardStyles}>
        ...
        <form className="space-y-4">
          ...
          <div>
            <Label htmlFor="confirmPassword" className={isWireframe ? 'text-black' : ''}>
              Confirm Password
            </Label>
            <Input
              id="confirmPassword"
          ...
          <div className="flex items-start gap-2">
            <input
              type="checkbox"
              id="terms"
              className={isWireframe ? 'mt-1 border-2 border-gray-400' : 'mt-1'}
            />
            <label htmlFor="terms" className={isWireframe ? 'text-sm text-black' : 'text-sm text-gray-600'}>
              I agree to the{' '}
              <Link to="/terms" className={isWireframe ? 'underline' : 'text-[#2563EB] hover:underline'}>
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy" className={isWireframe ? 'underline' : 'text-[#2563EB] hover:underline'}>
                Privacy Policy
              </Link>
            </label>
          </div>
